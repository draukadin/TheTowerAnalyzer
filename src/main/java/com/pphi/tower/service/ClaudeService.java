...
public class ClaudeService {
    ...
    public ChatResponse chat(ChatRequest request) {
        try {
            ...
            String systemPrompt = claudeProperties.resolvePrompt(request.promptKey());
            if (systemPrompt == null) systemPrompt = FALLBACK_SYSTEM_PROMPT;

            String reply = claudeRepository.sendChat(systemPrompt, request.prompt(), request.history(), preamble);
